...
constexpr Catch::Generators::GeneratorWrapper<sul::dynamic_bitset<Block>>
randomDynamicBitset(uint32_t seed = Catch::Generators::Detail::getSeed());

template<typename Block>
constexpr Catch::Generators::GeneratorWrapper<sul::dynamic_bitset<Block>>
randomDynamicBitset(typename sul::dynamic_bitset<Block>::size_type min_size,
                    typename sul::dynamic_bitset<Block>::size_type max_size,
                    uint32_t seed = Catch::Generators::Detail::getSeed());

template<typename Block>
class RandomDynamicBitsetGenerator : public Catch::Generators::IGenerator<sul::dynamic_bitset<Block>>
{
public:
    ...
    constexpr explicit RandomDynamicBitsetGenerator(uint32_t seed = Catch::Generators::Detail::getSeed());
...
template<typename Block>
constexpr Catch::Generators::GeneratorWrapper<sul::dynamic_bitset<Block>> randomDynamicBitset(uint32_t seed)
{
